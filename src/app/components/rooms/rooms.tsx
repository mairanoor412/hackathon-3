    ...
    return (
        <div>{loading ? (
            <div className="h-[100vh] w-full flex justify-center items-center bg-secondary ">
                ...
                <span className="loading loading-spinner loading-md  text-[#B88E2F]"></span>
            ...
            <div className="overflow-x-hidden w-full h-[450px] sm:h-[550px] md:h-[600px] lg:h-[670px] flex flex-col justify-center items-center bg-[#FCF8F3]">
                <div className=" grid grid-cols-2">
                    ...
                    <div className=" flex flex-col justify-center items-center min-w-[100px] col-span-1 gap-3 lg:gap-10 lg:ml-10 py-10 px-3 sm:px-16 xl:px-32">
                        <div className="flex flex-col gap-5">
                            <h1 className=" text-[17px] font-[700] sm:text-[20px]   md:text-[30px] sm:w-[190px] md:w-[300px] lg:w-[400px] lg:text-[36px] lg:leading-[48px] text-[#3A3A3A]  xl:w-[422px] xl:text-[40px]"> 50+ Beautiful rooms inspiration </h1>
                            <p className=" text-[12px]  font-[500] sm:text-[10px]   md:text-[12px] sm:w-[190px] md:w-[300px]  text-[#616161] lg:w-[334px] lg:text-[14px]  xl:w-[368px] xl:text-[16px]"> Our designer already made a lot of beautiful prototipe of rooms that inspire you </p>
                            <Link href="/shop">
                                <button className=" w-[100px] py-[8px] text-[12px] rounded-[5px] sm:w-[88px] sm:py-[6px] sm:text-[8px] md:w-[118px] md:py-[9px] md:text-[12px] lg:w-[176px] lg:py-[12px] lg:text-[16px] bg-[#B88E2F]  hover:text-secondary hover:font-[700]  font-[600] transition-all duration-300 ease-in-out transform hover:scale-105 hover:translate-y-[-2px] "> Explore More </button>
                            </Link>
                        </div>
                    </div>
